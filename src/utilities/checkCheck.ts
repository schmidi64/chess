...
const checkCheck = (square: string[][], isBlackNext: boolean, setMyPossibleSteps: React.Dispatch<React.SetStateAction<calculateNextEnemyStepsReturn[]>>, setPossibleEnemyKingSteps: React.Dispatch<React.SetStateAction<number[][] | undefined>>): boolean => {
