...
const checkCeckmate = (square: string[][], isBlackNext: boolean): boolean => {
    ...
    console.log(positionEnemyKing)
    console.log(myPossibleSteps)
    console.log(myPossibleSteps.flatMap((cell) => cell[0] === positionEnemyKing[0] && cell[1] === positionEnemyKing[1] ? true : false).filter((e) => e !== false)[0] )
